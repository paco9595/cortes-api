...
function get(req, res) {
    ...
    var sql = 'SELECT pieza.altura,pieza.anchura, vidrio.nombre vidrio.espesor FROM pieza INNER JOIN vidrio ON vidrio.id_vidrio=pieza.id_vidrio and id_usuario = ' + id+' ORDER BY vidrio.espesor DESC';
